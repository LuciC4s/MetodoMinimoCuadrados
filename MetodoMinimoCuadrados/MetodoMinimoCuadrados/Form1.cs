...
namespace MetodoMinimoCuadrados
{
    public partial class Form1 : Form
    {
        ...
        private int n = 0;
        private DataTable datosIniciales;
        public Form1()
        {
            InitializeComponent();
        ...
        {
            datosIniciales = new DataTable();
            datosIniciales.Columns.Add("X", typeof(int));
            datosIniciales.Columns.Add("Y", typeof(int));

            // Agrega tus datos iniciales a la tabla
            datosIniciales.Rows.Add(1, 5);
            datosIniciales.Rows.Add(2, 10);
            datosIniciales.Rows.Add(3, 8);
       ...
       private void Tabla_CellClick(object sender, DataGridViewCellEventArgs e)
        ...
        {
            string message = "Majito y Lucia";
            MessageBox.Show(message);
        }

        private void txtResultadoM_Click(object sender, EventArgs e)
        {

        }

        private void totalY_Click(object sender, EventArgs e)
        {
        ...
        private void btnLimpiar_Click(object sender, EventArgs e)
        {
            ...
            // Recrear área del gráfico
            ChartArea area1 = new ChartArea("area1");
            grafica.ChartAreas.Add(area1);

            // Recrear serie de datos
            Series recta = new Series("Recta");
            recta.ChartArea = "area1";
            recta.ChartType = SeriesChartType.Point;
            recta.Color = Color.Blue;
            grafica.Series.Add(recta);

            // Agregar puntos a la serie recta
            //recta.Points.AddXY(0, Math.Round(resultadob, 2, MidpointRounding.ToEven).ToString());
            //recta.Points.AddXY(Math.Round(resultadoPE, 2, MidpointRounding.ToEven).ToString(), 0);
